...
<section id="new-product">
    <div class="container mt-4">
        ...
        <div class="mt-3">
            <h4>Semua</h4>
            <p class="product-description">Produk Terbaru</p>
            <div class="row text-center mt-3 mb-4">
                <?php foreach ($productU as $rowU): ?>
                    <div class="col-6 col-lg-3 col-sm-6">
                        <figure class="figure">
                            <div class="figure-img">
                                <img src="<?= $rowU->image ? base_url("images/product/$rowU->image") : base_url("images/product/default.jpg") ?>" class="figure-img img-fluid" alt="">
                                <a href="<?= base_url("shop/detail/$rowU->slug") ?>" class="d-flex justify-content-center">
                                    <img src="<?= base_url() ?>assets/img/detail.png" alt="" class="align-self-center">
                                </a>
                            </div>
                            <figcaption class="figure-caption">
                                <h5><?= $rowU->title ?></h5>
                                <p>IDR <?= number_format($rowU->price, 0, ',', '.') ?></p>
                            </figcaption>
                        </figure>
                    </div>
                <?php endforeach ?>
            ...
            <h4>PRIA</h4>
            <p class="product-description">Produk Terbaru Untuk Pria</p>
            <div class="row text-center mt-3 mb-4">
            ...
            <h4>WANITA</h4>
            <p class="product-description">Produk Terbaru Untuk Wanita</p>
            <div class="row text-center mt-3 mb-4">
